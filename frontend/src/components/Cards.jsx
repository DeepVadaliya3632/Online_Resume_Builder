...
import { Award, Edit, Trash2, TrendingUp, Zap, Clock, Check } from "lucide-react";
        ...
        user && (
            <div className={cardStyles.profileCard}>
                ...
                <div className={cardStyles.profileName}>
                    <div className={cardStyles.profileInitialsText}>
                        {user.name || ""}
                    </div>
...
export const TemplateCard = ({ thumbnailImg, isSelected, onSelect }) => {
    return (
        <div
            className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-lg rounded-3xl ${isSelected
