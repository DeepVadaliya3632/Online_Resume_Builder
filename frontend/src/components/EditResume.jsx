...
import { AlertCircle, ArrowLeft, Check, Download, Loader2, Palette, Trash2 } from 'lucide-react'
...
import { WorkExperienceForm, AdditionalInfoForm, CertificationInfoForm, ContactInfoForm, EducationDetailsForm, ProfileInfoForm, ProjectDetailForm, SkillsInfoForm } from './Forms'
...
const EditResume = () => {
    ...
    // take back to prevoius form state or take back to first or to dashboard
    const goBack = () => {
        const pages = [
            "profile-info",
            "contact-info",
    ...
    //it will help choosing preview as well as downloading the resume also save resume as an image 
    ...
    // so all this function will be used for the resume.
                        ...
                        <div className={containerStyles.previewContainer}>
                            <div className='text-center mb-4'>
                                <div className={statusStyles.completionBadge}>
                                    ...
                                    <span>Preview - {completionPercentage}% Complate</span>
                                </div>
                            </div>
