...
import { inputStyles as styles, titleInputStyles, photoSelectorStyles } from '../assets/dummystyle.js';
import { EyeOff, Edit, Check, Trash2, Camera } from 'lucide-react';

export const Input = forwardRef(({ value, onChange, label, placeholder, type = 'text' }, ref) => {
