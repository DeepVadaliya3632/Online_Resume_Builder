...
import { commonStyles, dashboardStyles as styles } from '../assets/dummystyle.js'
...
const Dashboard = () => {
    ...
    const fetchAllResumes = async () => {
        try {
            setLoading(true);
            console.log("Fecthing resume from:",API_PATHS.RESUME.GET_ALL)
            ...
            console.log("resume with complation:", resumesWithCompletion);
            setAllResumes(resumesWithCompletion);
        }
        catch (error) {
            // console.error("error fetching resumes:", error)
            // console.error("error details:", error.response?.data || error.message);
            // toast.error("failed to fetch resumes. please check is the server is running")
            console.error("error fetching resumes:", error);
        }
        finally {
            setLoading(false);
                ...
                <div className={styles.headerWrapper}>
                    <div>
                        ...
                        <p className={styles.headerSubtitle}>
                            {allResumes.length > 0 ? ` You have ${allResumes.length} resumes${allResumes.length !== 1 ? 's' : ''}` : 'Start bulding your professional resume!'}
                        </p>
                    </div>
                ...
                {!loading && allResumes.length === 0 && (
                    <div className={styles.emptyStateWrapper}>
                        ...
                        <p className={styles.emptyText}>
                            You haven't created any resumes yet. Start building your professional resume to land you dream job!
                        </p>
                ...
                <div className='p-4'>
                    <div className='flex flex-col items-center text-center'>
                        <div className={styles.deleteIconWrapper}>
                            <LucideTrash2 size={24} className='text-orange-600'></LucideTrash2>
                        </div>
